--
-- Benchmark-only baseline copied from CartoDB cartodb-postgresql:
-- https://github.com/CartoDB/cartodb-postgresql/blob/master/scripts-available/CDB_JenksBins.sql
--
-- Original copyright: Copyright (c) 2014, Vizzuality.
-- Original license: BSD 3-Clause; see the upstream repository LICENSE.
--
-- This file is not installed with pg_eviltransform. It is loaded only by
-- scripts/benchmark_jenksbins.sh to compare the legacy SQL heuristic against
-- Rust-backed ST_JenksBins.
--
--
